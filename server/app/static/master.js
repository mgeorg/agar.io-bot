...
////////////////////////////////////////
    // I think this "variable" class "c" is the state of the world.
////////////////////////////////////////
    var c = function(a, b) {
...
(function(b) {
    function y(a) {
        return a in p ? +p[a] : null != b.localStorage ? (null == b.localStorage[a] && (b.localStorage[a] = 0 + ~~(100 * Math.random())), +b.localStorage[a]) : 0
    }

    function z(a) {
        if (u) {
            for (var d = [], c = 0; c < a.length; c++) "type" in a[c] && "dfpads" != a[c].type ? console.log("trying to refresh a non dfp ad. continue") : (h && console.log("DFP: refreshing:" + a[c].data.A), d.push(a[c].data));
            0 >= d.length || !b.googletag || b.googletag.cmd.push(function() {
                v && (v = !1, setTimeout(function() {
                    v = !0
                }, 0), b.googletag && b.googletag.pubads && b.googletag.pubads().refresh && b.googletag.pubads().refresh(d))
            })
        } else console.log("dfpInitialized=" + u), console.log("queuing refresh"), w = a
    }

    function q() {
        return !(5 > x("ABGroupRubicon"))
    }
    ...
    var u = !1,
        w = null,
        m = function(a) {
            a.defineSlot = function(a, c, f) {
                var g = b.googletag;
                return {
                    type: "dfpads",
                    data: g.defineSlot(a, c, f).addService(g.pubads())
                }
            };
            return a
        }({});
    ...
    var l = function(a) {
        a.b = function(a, c, b) {
            ...
            k.style.cssText = "width: " + c[0] + "px; height: " + c[1] + "px; border: 0; margin: 0; padding: 0; overflow: hidden;";
            ...
            a.open().write("<html>\n<head>\n<script type='text/javascript'>inDapIF=true;\n</script>\n</head>\n<body style='margin : 0; padding: 0;'>\n<!-- Rubicon Project Smart Tag -->\n<script type='text/javascript'>\nrp_account = '" + b.acct + "';\nrp_site = '" + b.site + "';\nrp_zonesize  = '" + b.zone + "-" + b.size + "';\nrp_adtype = 'js';\nrp_kw = '" + b.kw + "';\nrp_visitor = " + b.visitor + ";\nrp_inventory = " + b.inventory + ";\n</script>\n<script type='text/javascript' src=\"" + g + "//ads.rubiconproject.com/ad/" + b.acct + '.js"></script>\n</body>\n</html>');
            a.close()
        };
        a.defineSlot = function(a, c, f) {
            c = {
            ...
            f.kw = b.rpx_params.kw;
            f.visitor = JSON.stringify(b.rpx_params.visitor);
            f.inventory = JSON.stringify(b.rpx_params.inventory);
            c.data.json = f;
            return c
        };
        a.f = function(a, c, f) {
            var g = a + "-fif",
                e = b.jQuery("#" + g);
            null != e ? e.remove() : console.log("couldn't find element", e, g);
            this.b(a, c, f)
        };
        a.c = function(a) {
            a = a + "-fif";
    ...
    b.destroyAd = function(a) {
        for (var d = [], c = 0; c < a.length; c++) "type" in a[c] && "dfpads" != a[c].type || (h && console.log("DFP: destroying:" + a[c].data.A), d.push(a[c].data));
        b.googletag && b.googletag.pubads && b.googletag.pubads().clear && b.googletag.pubads().clear(d);
        for (d = 0; d < a.length; d++) "type" in a[d] && "rubicon" != a[d].type || (h && console.log("Rubicon: destroying:" + a[d].data.id, a[d]), l.c(a[d].data.id))
    };
    var t = {
        a: !1
    };
    b.agarAdModule = t;
    r.ABGroupDFP = y("AB9");
    r.ABGroupRubicon = y("AB12_Rubicon");
    ...
    (function() {
        var a = {},
            ...
            k = q() && !h,
            l = t.a;
        h ? (a = "/53945695/agar_facebook/agar/300x250", f = "/53945695/agar_facebook/agar/300x250_Stats", g = "/53945695/agar_facebook/agar/300x250") : (g = "/116850162/300x250_init", d = "/116850162/728x90_init", a = "/116850162/300x250_login", f = "/116850162/300x250_stats", c = "/116850162/728x90_login");
        var n = b.googletag;
        n.cmd.push(function() {
            n.pubads().setTargeting("abtest", x("ABGroupDFP") + "");
            e.ac.push(m.defineSlot(g, [300, 250], "g300x250"));
            l && e.ac.push(m.defineSlot(d, [728, 90], "g728x90"));
            k || (e.ab.push(m.defineSlot(f, [300, 250], "s300x250")), e.aa.push(m.defineSlot(a, [300, 250], "a300x250")), l && e.aa.push(m.defineSlot(c, [728, 90], "a728x90")));
            n.pubads().enableSingleRequest();
            n.pubads().disableInitialLoad();
            n.enableServices();
            u = !0;
            null != w && (console.log("refreshing from queue"), z(w))
        })
    })();
    (function() {
        if (q()) {
            ...
            if (-1 == b.location.search.indexOf("fb")) {
                var c = t.a;
                e.ab.push(l.defineSlot(a, "300x250", "s300x250"));
                e.aa.push(l.defineSlot(a, "300x250", "a300x250"));
                c && e.aa.push(l.defineSlot(d, "728x90", "a728x90"))
            }
        }
    })();
    h && console.log("Ads initted");
    h && console.log("Your group: ", q() ? "rubicon" : "dfp");
    (function() {
